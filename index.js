...
//the nested function can access 'internal' because of function scope. Functions have access to any variables outside of themselves (but code outside the function can't access variables inside).
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimalsCB) {
    const namesLowerCase = zooAnimalsCB.map((animal) => {
...
//console.log(lowPopulationAnimals(zooAnimals));
  ...
  */
  ...
  function consume(a, b, cb){
    const returnValue = cb(a,b);
    return returnValue;
  };
  // console.log(consume(1,2, add));
  // console.log(consume(1,2, multiply));
  // console.log(consume('Kelsey', 'Hunt', greeting));
